...
<style type="text/css">
	@media print{
		 @page 
        {
            ...
            margin: 0mm 30px 0 30px;/* this affects the margin in the printer settings */
        }
...
?>
<body>
 <table id="dailreporttable" border style="position:relative; border-collapse:collapse;">
	<tr>
...
Amount		</th>
	...
	echo "</td>";
	echo "<td class='pname'><div style='white-space:nowrap;max-width:150px;overflow:hidden;text-overflow:ellipsis'>$dailyrow[lname], $dailyrow[fname]</div></td>";
	...
	//get the amount of the payment
		...
		echo "<td>Tuition </td>";
		echo "<td $cancel align:right class='dailyamount tuicolumn' name='$tuitotal'>".number_format($tuitotal,2)."</td>";
		...
		echo "<td $cancel align='right' class='dailyamount misccolumn' name='$misctotal'>".number_format($misctotal,2)."</td>";
		...
		echo "<td $cancel class='tfcolumn' name='$tftotal' align='right'>".number_format($tftotal,2)."</td>";
		echo "<td $cancel class='dailyamount collectioncolumn' align='right' name='$horizontaltotal'>".number_format($horizontaltotal,2)."</td>";
		echo "<td class='remark' align='center'>";
	...
	echo "<tr>";
		...
		echo "<td></td>";
		echo "<td></td>";
		echo "<td class='tuicolumn' name='0' align='right'>".number_format($tuitiontotal2,2)."</td>";
		echo "<td></td>";
		echo "<td class='misccolumn'  name='0' alijgn='right'>".number_format($misctotal2,2)."</td>";
		echo "<td></td>";
		echo "<td class='tfcolumn' name='0' align='right'>".number_format($tftotal2,2)."</td>";
		echo "<td class='collectioncolumn' name='0' align='right'>".number_format($collectionamount,2)."</td>";
		echo "<td>";
