	...
	<div id="schedsearch">
		<div id="headeroption">
	 	...
	 	<img src="img/loading.gif" id="addschedloader">
	 			<span id="addstudent" onclick="loadaddsched()">Add Other School Fees</span>
		...
		<div id="schedopt">
			<img src="img/loading.gif">
	 		...
	 		School Year: <select>
				<?php
					$getschoolyear=mysql_query("select distinct sy from schedule_of_fees order by sy desc");
	...
	<table id="rletable" border>
		...
		<tr class="rlerow rlerow<?=$course['course_id'];?> rlegroup<?=$course['sched_id'];?>" id="rlerow<?=$course['sched_id'];?>" name="<?=$course['sched_id'];?>" rlecourse="<?=$course['course_id'];?>">
			...
			<td style="text-align:center">
				<select schedid="<?=$course['sched_id'];?>"  refreshval="<?=$course['year_level'];?>" name="<?=$course['course_id'];?>" class="rleyear" onchange="checkrlecourse(this,<?=$course['course_id'];?>)">
	...
	<script type="text/javascript" src="js/scheduleoffees.js">
	</script>