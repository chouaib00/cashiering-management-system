...
?>
 <table id="dailreporttable" border style="width:8in;border-collapse:collapse;margin:0 auto">
	<tr>
...
Amount		</th>
	...
	echo "</td>";
	echo "<td class='pname'><div style='white-space:nowrap'>$dailyrow[lname], $dailyrow[fname]</div></td>";
