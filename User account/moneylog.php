...
$getlastdate=mysql_query("select * from collection where user_id='$_SESSION[user_id]' order by col_id desc limit 1");
	 ...
	 <tr>
	 	<td colspan="11" style="background:url('img/userlistheader.png');height:25px">
	 		<div style="float:right;color:white">
	 			Search: <input type="date" style="padding:2px"  onchange="searcmoneylog(this.value)">
	 		</div>
	 	</td>
	 </tr>
