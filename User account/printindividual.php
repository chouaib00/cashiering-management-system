...
<body>
  <table id="dailreporttable" border style="border-collapse:collapse">
	<tr>
...
Amount		</th>
	...
	echo "<td $cancel  style=' width:300px' id='orcon'>$dailyrow[receipt_num]";
 	 ...
 	 <?php
	echo "</td>";
	echo "<td class='pname' style='white-space:nowrap'>$dailyrow[lname], $dailyrow[fname]</td>";
