...
#listcon {height:140px; display:block;width:inherit;position:relative;top:37px;}
...
?>
<title>&nbsp;</title>
<div style="margin-left:20px;position:relative;width:3.9in;padding:0.78in 0 0 0; ">
	...
	<div id="numbertoword"> <?=receivenumber($total);?> only</div>
 	<div style="padding-left:5px">
		Amount received: <?=number_format($cash2,2);?><br>
		Change: <?=number_format($cash2-$total,2);?><br>
	</div>
</div>
